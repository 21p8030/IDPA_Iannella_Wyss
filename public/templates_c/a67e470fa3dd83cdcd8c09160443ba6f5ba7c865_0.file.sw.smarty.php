...
<div>
    <ul style="list-style-type: none; display: flex">
        ...
        <li style="margin-right: 20px;"><a href="/public/kinematik/sw"><span class="text-success">Senkrechter Wurf</span></a></li>
...
<div class="flex_wrapper">
    ...
    <div><br>Fallphase:<br>
    Bei der Fallphase gelten dieselben Regeln wie beim Freien Fall:<br>
    -	Die Dauer der Steigung entspricht der Dauer des Fallens.<br>
    -	Der Körper trifft den Abwurfort mit der ursprünglichen Abwurfgeschwindigkeit.
    </div>
</div>
...
>
  ...
  const GWZ2 = document.getElementById('GWZ_')
  const tsv = document.getElementById('tsv')
  const svt = document.getElementById('svt')
  
  var GWZ_formula_pretty = "v=v0+g*t";
  var GWZ_formula = "h= v0  *t+  g/2  * t^2";
  var tsv_formula = "v= sqrt(v0^2+2 *g *h)";
  var svt_formula = "h=  (v+ v0)/2  *t";
