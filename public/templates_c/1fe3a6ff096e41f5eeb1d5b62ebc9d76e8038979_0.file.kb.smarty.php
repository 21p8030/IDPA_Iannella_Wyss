...
function content_62ac9b28b30d95_03998277 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="de">
<head>
...
>
  ...
  var GWZ_formula_pretty = "Winkelgeschwindigkeit (ω)=  (Winkel (∆φ))/(Zeit (∆t))";
  var tsv_formula = "ω=  2π/T=2π *  1/T=2π *Frequenz (f)→in Hz bzw.  s^-1";
  //var tsv_formula = "t=s/v";
  var svt_formula = "v=  (Bogenweg (∆b))/t=spez.→  2πr/T=2πfr= ω *Radius (r)";
